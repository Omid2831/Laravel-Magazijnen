...
@section('content')
    <h1 class="text-3xl font-bold text-gray-800 mb-6">Overzicht Magazijn Jamin</h1>
            ...
            <tbody>
                @foreach ($Magazijnen as $Magazijn)
                    <tr>
                        ...
                        <td class="border border-gray-400 px-4 py-2">
                            <a href=""
                                class="text-gray-500 hover:text-blue-600 hover:drop-shadow-lg hover:shadow-pink-500/50 transition-all duration-300 hover:font-semibold hover:scale-105">
                                View Product
                            </a>
                        </td>
                    </tr>
