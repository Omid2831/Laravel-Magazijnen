        ...
        <div class="w-full max-w-lg bg-white rounded-2xl shadow-lg p-8 border border-gray-200">
            ...
            @if (session('success'))
                <div id="success-message"
                    class="flex items-center justify-between bg-green-100 text-green-800 px-4 py-3 rounded-lg mb-5 shadow-sm border border-green-300">
            ...
            @if ($errors->any())
                <div id="error-message"
                    class="flex items-center justify-between bg-red-100 text-red-800 px-4 py-3 rounded-lg mb-5 shadow-sm border border-red-300">
